...
import { GiArtificialIntelligence } from "react-icons/gi";  // ✅ FIXED: Import this icon
...
const PopularCategories = () => {
  const categories = [
    ...
    { id: 6, title: "Artificial Intelligence", subTitle: "867 Open Positions", icon: <GiArtificialIntelligence /> }, // ✅ FIXED
